...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" layerType="Vector" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="4.2.1-Belém do Pará">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="RandomMarkerFill" enabled="1" id="{3c2d1803-f160-45ce-beb0-210b76f46dfb}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="point_count" type="QString" value="10"/>
            <Option name="seed" type="QString" value="760549105"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
                <Option name="pointCount" type="Map">
                  ...
                  <Option name="expression" type="QString" value="rand(1,5)"/>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="@0@0" type="marker">
            ...
            <layer class="RasterMarker" enabled="1" id="{be8e3884-62b2-44b1-9b2f-a8a843311996}" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    ...
                    <Option name="name" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="@project_folder||'/digger.png'"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="randf(3,6)"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                  </Option>
                  <Option name="type" type="QString" value="collection"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="0" name="QuarryName">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="QuarryName" index="4" name=""/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="QuarryName"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="QuarryName" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="QuarryName"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;Height&quot;" sortOrder="1">
    <columns>
      ...
      <column hidden="0" name="QuarryName" type="field" width="350"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="QuarryName"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="QuarryName"/>
  ...
  <reuseLastValuePolicy>
    ...
    <field name="QuarryName" reuseLastValuePolicy="NotAllowed"/>
